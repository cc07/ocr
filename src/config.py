...
flags.DEFINE_string('img_path', '../data/images', 'Path location of images for training')
...
flags.DEFINE_integer('batch_size', 16, 'Number of samples for each training epoch')
flags.DEFINE_integer('n_filters', 32, 'Number of filters for each CNN')
flags.DEFINE_integer('n_rnn_cells', 2, 'Number of cells rnn layer')
flags.DEFINE_integer('n_units', 512, 'Number of units in each rnn cell')
flags.DEFINE_integer('n_epochs', 10000, 'Number of training epoch')
